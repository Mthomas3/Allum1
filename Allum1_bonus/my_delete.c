...
** Last update Thu Feb 19 01:24:33 2015 Thomas Martins
*/
...
int	print_two_exit(t_alum *am, char *new)
{
  ...
  my_putstr("L'ia vient de perdre, vraiment bravo!");
  my_putstr("L'IA boude, du coup elle quitte le programme :( bravo!!\n");
  my_putstr("Bon aller, tu as le choix tape EXIT ou REPLAY! :)\n");
  my_putstr("\033[0m");
  if (!(new = get_next_line(0)))
    return (-1);
  return (0);
}
